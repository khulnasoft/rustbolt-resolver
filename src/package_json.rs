...
impl PackageJson {
    ...
    ///
    /// This is currently used in Rustbolt for:
    /// * getting the `sideEffects` field
    /// * query in <https://www.rustbolt.dev/config/module.html#ruledescriptiondata> - search on GitHub indicates query on the `type` field.
    ///
