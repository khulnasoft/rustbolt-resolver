...
> [!NOTE]  
>  This is a fork of [oxc-resolver](https://github.com/oxc-project/oxc-resolver), and will be used in Rustbolt cause 100% compatible with enhanced-resolve is the non-goal of oxc-resolver itself, we may add enhanced-resolve specific features like [`pnp support`](https://github.com/khulnasoft/rustbolt/issues/2236) and [`alternative support`](https://github.com/khulnasoft/rustbolt/issues/5052) in the future.
